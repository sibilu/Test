...
public class audioplugin_BPFilterGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_BPFilter"; } }
    public override string Description    { get { return "BPFilter"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
    [DllImport("audioplugin_BPFilter")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_BPFilter")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_BPFilter")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_BPFilter")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_BPFilter")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_BPFilter")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_BPFilter")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
